-- This script fixes the issue where changes to departments and support services in shifts
-- affect the default settings. It creates separate tables for default assignments and
-- implements a database trigger to copy these defaults to new shifts automatically.

-- First, create new tables for default assignments
...
-- Next, migrate existing data from the current tables to the new default tables

-- Migrate area cover assignments
...
-- Migrate area cover porter assignments
...
-- Migrate service cover assignments
...
-- Migrate service cover porter assignments
...
-- Finally, create the database trigger function to copy defaults to new shifts

-- Function to copy default assignments to a new shift
